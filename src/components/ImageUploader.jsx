...
export const ImageUploader = ({ defaultWidth, defaultHeight }) => {
  ...
  return (
    <div className='container-flex'>
      ...
      <div className="image-uploader">
        {!selectedImage && (
          <div className="custom-file-upload__box">
            <div className="icon">
        ...
        {selectedImage && (
          <div>
            <img src={selectedImage} alt="Selected" style={getImageStyle()} />
            {/* <p>Название: {imageName}</p> */}
          </div>
        )}
      </div>
      {active && (
        <div className='container-settings'>
          ...
          <div>
            <label htmlFor="fit">Масштабирование:</label>
            <input id="fit" type="checkbox" checked={fitContain} onChange={handleFitChange} />
          </div>
        </div>
      )}
    </div>
